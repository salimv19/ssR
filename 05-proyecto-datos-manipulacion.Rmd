...
`M2_219.xlsx` y se puede observar un ejemplo de éstos en la figura \ref{fig:ejerciciofinal}.
El ejercicio consiste en leer los datos y limpiarlos de forma que sean datos
limpios^[Los datos fueron tomados de [@informe, págs. 218-219] y el catálogo de estados se tomó de [@mgn]].
