...
[@tidyr]. En la figura \ref{fig:ciclo2} podemos ver la etapa del
...
```{r estructurat, out.width='50%', fig.show='hold', fig.align = 'center', fig.cap='Mismos datos que en \ref{fig:estructura} pero traspuestos.', echo = FALSE, results='hold'}
