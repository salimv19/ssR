...
estructuras de control disponibles en el lenguaje. El capítulo [4](#vectorizacion), explica 
...
El capítulo [5](#introduccion), detalla las herramientas básicas para poder realizar un proyecto
